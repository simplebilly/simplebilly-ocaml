# SimpleBilly OCaml SDK

[![Release](https://img.shields.io/github/v/release/simplebilly/simplebilly-ocaml?label=release&logo=github)](https://github.com/simplebilly/simplebilly-ocaml/releases)
[![CI](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/release.yml/badge.svg)](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/release.yml)
[![CodeQL](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/codeql.yml/badge.svg)](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/codeql.yml)
[![Scorecard](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/scorecard.yml/badge.svg)](https://github.com/simplebilly/simplebilly-ocaml/actions/workflows/scorecard.yml)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/simplebilly/simplebilly-ocaml/badge)](https://scorecard.dev/viewer/?uri=github.com/simplebilly/simplebilly-ocaml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Docs](https://img.shields.io/badge/docs-simplebilly.com-blue)](https://simplebilly.com/api/docs)

Official OCaml client for the [SimpleBilly API](https://simplebilly.com/api/docs).
...
> published under [Releases](https://github.com/simplebilly/simplebilly-ocaml/releases).

## Installation

The package is published to the OCaml package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages) for public repos — free for public packages).
See the [Releases](https://github.com/simplebilly/simplebilly-ocaml/releases) page for the list
